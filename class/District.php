...
class District {
    ...
    public function create() {
        ...
        $query = "INSERT INTO `district` (`name`,`queue`) VALUES  ('"
                . $this->name . "','"
                . $this->queue . "')";
    ...
    public function all() {
        ...
        $query = "SELECT * FROM `district` ORDER BY queue ASC";
    ...
    public function GetDistrictByProvince($province) {
        ...
        $query = "SELECT * FROM `district` WHERE `province` = '" . $province . "' ORDER BY `name` ASC";
    ...
    public function arrange($key, $img) {
        ...
        $query = "UPDATE `district` SET `queue` = '" . $key . "'  WHERE id = '" . $img . "'";
