jQuery(document).ready(function () {
    ...
    $("#create").click(function (event) {
        ...
        if (!$("#code").val() || $("#code").val().length === 0) {
            swal({
                title: "Error!",
                text: "Please enter a Company Number",
                type: "error",
                timer: 2000,
            ...
            $.ajax({
                url: "ajax/php/company-master.php",
                type: "POST",
                data: formData,
                async: false,
                cache: false,
    ...
    // Delete Company
    $(document).on("click", ".delete-company-master", function (e) {
        e.preventDefault();
    ...
    $("#new").click(function (e) {
        ...
        // Optional: Reset selects to default option
    ...
    $(document).on("click", ".select-company-master", function () {
